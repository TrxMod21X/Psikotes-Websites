					...
					<div class="col-lg-12">
						...
						<div class="card-body">
							...
							?>
										...
										<tr>
											<td>&nbsp;</td>
											<td>
												<input class="btn btn-success" type="submit" name="submit" value="Jawab" onclick="return confirm('Apakah Anda yakin dengan jawaban Anda?')">
											</td>
											
										</tr>
											<td>
												<input style="display: none;" type="submit" name="submit2">
											</td>
										</table>
										</form>
										</p>
						...
						<script>
							...
							if (sessionStorage.getItem("menit") && sessionStorage.getItem("detik")) {
								...
								sessionStorage.setItem("detik", 0);
							}

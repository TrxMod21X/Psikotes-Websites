            ...
            <div class="card-body">
              ...
              switch ($_GET['act']) {
                ...
                default:
                  ...
                  <div class='row'>
                    <div class='col-lg-6'>
                      <input class='btn btn-primary' type=button value='Tambah Soal' onclick=\"window.location.href='?module=soal&act=tambahsoal';\">
                    </div>";
                  //Form Pencarian Data
                  //   echo "
                  ...
                  while ($r = mysqli_fetch_array($tampil)) {
                    ...
                    echo "
                      <tr>
                        ...
                        <td>
                            <a class='btn btn-outline-primary' href=?module=soal&act=editsoal&id=$r[id_soal] role='button'>
                            <i class='fa fa-edit mr-1'></i>
                            Edit</a> | 
                            <a class='btn btn-outline-danger' href=$aksi?module=soal&act=hapus&id=$r[id_soal] role='button'>
                            <i class='fa fa-trash mr-1'></i>
                            Hapus</a>
                        </td>
                        <td>
                          <a class='btn btn-outline-info' href='?module=soal&act=viewsoal&id=$r[id_soal]'>
                    ...
                    if ($r['aktif'] == "Y") {
                      echo "
                        <td>
                          <input type=button class='btn btn-outline-dark' value='Non Aktifkan' onclick=\"window.location.href='$aksi?module=soal&act=nonaktif&id=$r[id_soal]';\">
                        </td>";
                    } else {
                      echo "
                        <td align='center'>
                          <input class='btn btn-outline-success' type=button value='Aktifkan' onclick=\"window.location.href='$aksi?module=soal&act=aktif&id=$r[id_soal]';\">
                        </td>";
                    }
